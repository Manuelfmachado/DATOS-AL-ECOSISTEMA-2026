"""
Cargar solo geih_resumen_departamento después de corregir el schema.
EJECUTAR DESPUÉS de correr schema_fix_ocupados.sql en Supabase SQL Editor.
"""
import os
import pandas as pd
import numpy as np
...
def main():
    ...
    upload_table('geih_resumen_departamento', records)
